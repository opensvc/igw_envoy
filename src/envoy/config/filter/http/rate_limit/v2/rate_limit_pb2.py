...
_RATELIMIT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='domain', full_name='envoy.config.filter.http.rate_limit.v2.RateLimit.domain', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='stage', full_name='envoy.config.filter.http.rate_limit.v2.RateLimit.stage', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='request_type', full_name='envoy.config.filter.http.rate_limit.v2.RateLimit.request_type', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='timeout', full_name='envoy.config.filter.http.rate_limit.v2.RateLimit.timeout', index=3,
...
RateLimit = _reflection.GeneratedProtocolMessageType('RateLimit', (_message.Message,), dict(
  ...
  __module__ = 'envoy.config.filter.http.rate_limit.v2.rate_limit_pb2'
